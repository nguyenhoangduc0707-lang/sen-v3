$content = @"
Xin chào bạn, hôm nay chúng ta sẽ cùng nhau đi qua một hành trình nhỏ mang tên "Buông bỏ". 
...
Write-Host "✅ Nội dung đã được copy vào clipboard!" -ForegroundColor Green
Write-Host "👉 Quay lại trình duyệt Facebook, nhấn Ctrl+V để dán" -ForegroundColor Yellow
